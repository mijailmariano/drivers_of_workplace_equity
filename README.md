...
The medium-sized business employee dataset used in the analysis was generated by IBM's AI "Watson" as a way to help business practioners investigate potential drivers of employee attrition.
...
I make several assumptions throughout the analysis that can potentially play a role in the interpretation of my findings. Here are some of the key underlying assumptions for my analysis:
...
3. **acquire.py** 
   ...
   Python module file that imports the neccessary dataset. Once the dataset is pulled and loaded into a .ipynb file, it is then cached locally into a .csv file. All subsequent calling of this data will be referenced from the cached .csv.   
